...
Following commands used to generate the Gemm performance charts:<br>
`./sample_cublasLt_LtSgemm [M] [N] [K] 0`<br>

Following command is used to generate the NSight profile for a GEMM:<br>
`sudo ncu --set full -o [profile-name] ./sample_cublasLt_LtSgemm [M] [N] [K] 1`

### Resources to explore
[Fast CUDA SGEMM from Scratch](https://siboehm.com/articles/22/CUDA-MMM)<br>
[cuBLAS](https://developer.nvidia.com/cublas)<br>
[CUTLASS](https://docs.nvidia.com/cutlass/index.html)<br>
[openAI-GEMM](https://github.com/openai/openai-gemm)<br>
